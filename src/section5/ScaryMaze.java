...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("Whateveryouwant.jpg"));
	...
	public void mouseMoved(MouseEvent e) {
		...
		int backgroundColor = -65024;
		int end_Color = -16777216;
		int start_Color = -13959424;
		int white = -1;


		//8. If the mouse falls off the path (if it is on the background)
	if (mouseColor == backgroundColor || mouseColor != white || mouseColor != start_Color) {
